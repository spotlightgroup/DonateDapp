...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(http, web3) {
        this.http = http;
        this.web3 = web3;
        this.model = {
            header: "",
    ...
    HomeComponent.prototype.ngOnInit = function () {
        ...
        this.getPosts();
        setTimeout(function () {
            _this.model.publicKey = _this.web3.accounts[0];
            console.log(_this.model.publicKey);
        }, 2000);
    };
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _util_web3_service__WEBPACK_IMPORTED_MODULE_2__["Web3Service"]])
    ], HomeComponent);
